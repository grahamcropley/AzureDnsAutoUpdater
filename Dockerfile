...
RUN apt-get update
RUN apt-get install -y curl bash python3 python3-pip subversion
...
RUN svn export https://github.com/grahamcropley/AzureDnsAutoUpdater/tree/5c4ed8adf44c1a87c36470efe6c2562a2745b240/app
# ADD ./app/* /app/
